    ...
    <div className="min-h-screen pb-24" style={{ background: 'linear-gradient(180deg, #0a0a0a 0%, #0d0909 40%, #0a0a0d 70%, #0a0a0a 100%)' }}>
      ...
      <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden pt-16">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute top-0 left-0 right-0 h-0.5 bg-gradient-to-r from-blue-600 via-blue-400 to-blue-600 opacity-80" />
        ...
        <div className="relative z-10 w-full max-w-md mx-auto px-4 text-center">
          ...
          >
            {/* Badge */}
            <div className="inline-flex items-center gap-2 bg-blue-500/10 border border-blue-500/30 backdrop-blur-sm px-4 py-2 rounded-full mb-6 shadow-lg shadow-blue-500/10">
            ...
            {/* Subheadline */}
            <p className="text-blue-200/70 text-base mb-8 font-medium">Buy • Sell • Trade • Get Cash Today</p>
