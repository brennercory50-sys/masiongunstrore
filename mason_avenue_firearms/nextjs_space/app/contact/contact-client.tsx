...
import { Phone, MapPin, MessageSquare, Mail, Shield } from 'lucide-react';
      ...
      <div className="pt-24 sm:pt-28 pb-16 max-w-[1400px] mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.1 }} className="bg-[#060606] border border-white/[0.06] rounded-xl p-6">
            ...
            <a href="tel:3862264653" className="text-gray-400 text-sm hover:text-red-400 transition-colors block">(386) 226-4653</a>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.15 }} className="bg-[#060606] border border-white/[0.06] rounded-xl p-6">
            ...
            <a href="sms:3862264653" className="text-gray-400 text-sm hover:text-blue-400 transition-colors block">(386) 226-4653</a>
          ...
          <div className="bg-[#060606] border border-white/[0.06] rounded-2xl p-6 sm:p-10">
            ...
            <form className="space-y-4 max-w-lg" action="mailto:info@masonavenue.com" method="POST" encType="text/plain">
              <div>
                ...
                <input type="text" name="name" className="w-full bg-white/5 border border-white/[0.08] rounded-lg px-4 py-3 text-sm text-white placeholder:text-gray-700" placeholder="Your name" />
              </div>
              <div>
                <label className="text-[10px] text-gray-600 uppercase tracking-[0.15em] mb-1.5 block font-medium">Phone</label>
                <input type="tel" name="phone" className="w-full bg-white/5 border border-white/[0.08] rounded-lg px-4 py-3 text-sm text-white placeholder:text-gray-700" placeholder="(386) 555-0123" />
              </div>
              <div>
                <label className="text-[10px] text-gray-600 uppercase tracking-[0.15em] mb-1.5 block font-medium">Email</label>
                <input type="email" name="email" className="w-full bg-white/5 border border-white/[0.08] rounded-lg px-4 py-3 text-sm text-white placeholder:text-gray-700" placeholder="you@example.com" />
              </div>
              <div>
                <label className="text-[10px] text-gray-600 uppercase tracking-[0.15em] mb-1.5 block font-medium">Message</label>
                <textarea name="message" rows={4} className="w-full bg-white/5 border border-white/[0.08] rounded-lg px-4 py-3 text-sm text-white placeholder:text-gray-700 resize-none" placeholder="How can we help you?" />
              </div>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.4 }} className="bg-[#060606] border border-white/[0.06] rounded-2xl p-6 sm:p-10">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm">For FFL transfer inquiries, please call us directly at (386) 226-4653 or visit our FFL Transfer page.</p>
              <Link href="/ffl-transfer" className="text-red-400 hover:text-red-300 text-sm font-medium transition-colors inline-block mt-2">FFL Transfers →</Link>
            </div>
          </div>
        </motion.div>
      </div>
